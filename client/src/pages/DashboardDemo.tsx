...
import { BarChart3, AlertTriangle, TrendingUp, Users, Download, Plus } from "lucide-react";
import { BarChart, Bar, LineChart, Line, PieChart, Pie, Cell, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from "recharts";
import { useState } from "react";
import { toast } from "sonner";

/**
 * Dashboard Demo - No authentication required
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                Datos de ejemplo para demostración (174 evaluaciones importadas)
              </p>
            </div>
        ...
        <Card className="mt-8 bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
              Estás viendo datos de demostración. Para acceder con tu cuenta personal, usa el botón "Acceder a SIGER PRO" en la página de inicio.
            </p>
            <Button
              variant="outline"
              onClick={() => (window.location.href = "/")}
              className="border-blue-400 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900"
            >
              Volver a Inicio
            </Button>
          </CardContent>
